...
import time
from ytutils.CreateMovie import CreateMovie, GetDaySuffix
from ytutils.RedditBot import RedditBot
from ytutils.upload_video import upload_video


def uploading_short_video():
    ...
    while True:
        ...
        print("Posting Video in a minute...")
        time.sleep(60)
